...
# y=int(input("Enter any 2nd number:-"))
...
#Q3=>Swap two numbers using addition/subtraction/multiplication and division.

# x=int(input("Enter any 1st number:-"))
# y=int(input("Enter any 2nd number:-"))


#Q4=>Write a program to take input from runtime and print id and type of that input.
